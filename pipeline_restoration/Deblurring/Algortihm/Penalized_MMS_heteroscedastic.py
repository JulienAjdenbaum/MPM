...
def P_MMS(y, H, delta, eta, x_0, x_bar, x_min, x_max, res, noise_params, D_scale, max_iter, tolerance):
    ...
    while counter < max_iter and criterion > tolerance and time.time()-start_time < 10200:
        ...
        x_inner_new, x_inner, criterion = MMS(y, alpha, H, G, delta, x_0, x_old, x_bar, x_min, x_max, D_scale, 1000, EPSILON, GAMMA, (n1, n2, n3))
...
def MMS(y, alpha, H, G, delta, x, x_old, x_bar, x_min, x_max, D_scale, max_iter, EPSILON, GAMMA, shape):
    """
    Parameters
    ----------
...
def R2(Hx, y, alpha, D_scale):
    proj = proj_ball(D_scale * Hx, D_scale * y, np.sqrt(alpha))
